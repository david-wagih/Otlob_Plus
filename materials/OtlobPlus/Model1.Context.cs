...
namespace OtlobPlus
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual ObjectResult<string> getItems()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("getItems");
        }
        ...
        public virtual ObjectResult<Nullable<int>> returnUserID(string password)
        {
            var passwordParameter = password != null ?
                new ObjectParameter("Password", password) :
                new ObjectParameter("Password", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("returnUserID", passwordParameter);
        }
    
        public virtual ObjectResult<getUser_Result1> getUser(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getUser_Result1>("getUser", userIDParameter);
        }
    
        public virtual ObjectResult<getOrderByUserID_Result1> getOrderByUserID(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("UserID", userID) :
                new ObjectParameter("UserID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getOrderByUserID_Result1>("getOrderByUserID", userIDParameter);
        }
    }
}
